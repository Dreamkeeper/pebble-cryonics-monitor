...
- [ ] 1. Core: episode identity — `episode_seq` in cm_core (shell
...
- [ ] 2. Worker: monotonic clock — `s_mono_ms` from the tick stream
       ...
       (design D6).
- [ ] 3. Protocol: KEY_EPISODE=11, PMSG_ALARM_ACK=18, WMSG_STATUS
...
- [ ] 8. Companion: firmware-gated qmetric (design D7) — push
...
- [ ] 9. Versions + builds: watchapp 0.5.0 (protocol-breaking rev),
